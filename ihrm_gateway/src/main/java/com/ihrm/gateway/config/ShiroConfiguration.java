package com.ihrm.gateway.config;
...
public class ShiroConfiguration {
     ...
     */
    @Bean
    public ShiroFilterFactoryBean sessionManager(SecurityManager securityManager){
        //配置过滤器工厂
        ...
        filterFactory.setUnauthorizedUrl("/autherror?code=2");  //未授权的地址
        //设置过滤器集合
